...
def EditProfile(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            profile.phonenumber = form.cleaned_data.get('phonenumber')
            profile.camera_details = form.cleaned_data.get('camera_details')
            profile.email = form.cleaned_data.get('email')
            profile.rating = form.cleaned_data.get('rating')
            profile.save()
